...
const ProductCarousel = () => {
    ...
    return (
        <div className="mb-4 xl:block lg:block md:block text-white">
            {
                isLoading ? null : error ? (
                ...
                ) : <Slider {...settings} className="xl:w-[50rem] lg:w-[50rem] md:w-[56rem] sm:w-[40rem] sm:block" >
                    {
                        products.map(({ image, _id,
                            ...
                            brand, createdAt, numReviews,
                            rating, quantity, countInStock }) => (
                            <div className="w-full rounded-lg object-cover h-[30rem]"
                                key={_id}>
                                <img
                                    src={image}
                                    alt={name}
                                ...
                                <div className="flex justify-between w-[20rem]">
                                    ...
                                    <div className="flex justify0between w-[20rem]">
                                        <div className="one">
                                        ...
                                        <div className="two">
                                            ...
                                            <h1 className="flex items-center mb-6 w-[10rem]"> Quantity: {quantity}
